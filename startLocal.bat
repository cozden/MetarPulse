...
rem ── [1/5] PostgreSQL ───────────────────────────────────────────────────────
echo.
echo [1/5] PostgreSQL baslatiliyor...
cd /d %~dp0
...
rem ── [2/5] API ──────────────────────────────────────────────────────────────
echo.
echo [2/5] API baslatiliyor (dotnet run)...
...
rem ── [3/5] ngrok ────────────────────────────────────────────────────────────
echo.
echo [3/5] ngrok tunnel baslatiliyor (port 5000)...
where ngrok >nul 2>&1
if %ERRORLEVEL% NEQ 0 (
...
rem ── [4/5] Web ──────────────────────────────────────────────────────────────
echo.
echo [4/5] Web projesi baslatiliyor...
start "MetarPulse Web" cmd /k "cd /d %~dp0src\MetarPulse.Web && dotnet run --launch-profile http"

rem ── [5/5] MAUI Windows ────────────────────────────────────────────────────
echo.
echo [5/5] MAUI Windows uygulamasi baslatiliyor...
